%XXXXX INFO XXXXXX
% Lernhilfe für TheoInf2 Mit und ohne Lösungen*
\newif\ifanswers
\answerstrue % mit "%" auskommentieren, wenn ohne Lösung* gewünscht ist
% * Auf die korrektheit der Lösungen gibt es keine Garantie
